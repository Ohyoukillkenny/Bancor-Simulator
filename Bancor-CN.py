...
for TE in [50]:
    for R in [2.0]:
        for N in [50, 100, 200, 300, 500, 700, 1000, 1200, 1400, 1600, 1800, 2000]:
            for sig in [2.0]:
                ...
                for mySeed in mySeeds:
                    ...
                    #     plt.savefig('Figures/Bancor/CN/Price-TE-'+str(TE)+
                ...
                fw_statistic = open('Figures/Bancor/CN/TE-'+str(TE)+
