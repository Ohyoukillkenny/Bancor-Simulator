                ...
                for mySeed in mySeeds:
                    ...
                    for j in range(TimeSlotNum):
                        ...
                        if (j > 0) and (j % bouncingInterval == 0):
                            ''' 
                            Choose new valuation between (Ps / R, Ps * R)
                            '''
                        ...
                        for i in range(custNum):
                            # if custList[i].getReserveBalance() == 0:
                            #     # print int(custList[i].getTokenBalance()*currentMarketPrice)
                            #     custList[i].changeReserveBalance(200)
                    ...
                    plt.savefig('Figures/Bancor/Price-BI-'+str(bouncingInterval)+
